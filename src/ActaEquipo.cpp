...
/// Empaqueta los datos del partido en EstadisticasEquipo
/// para acumular sobre el historico con operator+=
EstadisticasEquipo ActaEquipo::toStats(bool gano, bool empato) const {
    ...
    s.setTarjetasAmarillas(am);
    s.setTarjetasRojas    (ro);
    s.setFaltas           (fa);
    return s;
}
